...
| :---         |     :---:      |     :---:     |           ---: |
| Обмін прикладними даними (HTTP)   |  Обмін прикладними даними (HTTP)    | > GET / HTTP/2,
< HTTP/2 200, 
> Host: sqlite.org    |  Ці рядки відповідають за безпосередній запит контенту вебсторінки та отримання відповідей у зрозумілому для клієнта текстовому форматі.     |
